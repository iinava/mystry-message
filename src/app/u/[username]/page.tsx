...
export default function SendMessage() {
  ...
  //wont work chat gpt api expiration
  // const {
  //   complete,
  //   completion,
...
//wont work cause chat gpt api expired
  ...
  return (
    <div className="container mx-auto my-8 p-6 text-white rounded max-w-4xl">
      <h1 className="text-4xl font-bold mb-6 text-center">
       Type Your anonymous message to <span>@{username}</span>
      </h1>
      <Form {...form}>
      ...
      <div className="text-center">
        <div className="mb-4">Get Your Message Board to recieve anonymous messges</div>
        <Link href={'/signup'}>
